...
export function Navigation({
  ...
  const menuItems: MenuItem[] = lang === 'en' ? [
    ...
    },
    {
      label: 'ACADEMICS',
      submenu: [
        { label: 'Study Program Curriculum', href: '/en/kurikulum#kurikulum' },
        { label: 'Prospectus', href: '/en/kurikulum' },
        { label: 'Graduate Profile', href: '/en/kurikulum#profil-lulusan' },
        { label: 'Graduate Learning Outcomes (PLO)', href: '/en/kurikulum#cpl' },
        { label: 'Research & Publications', href: '/en/tulisan-dosen' },
        { label: 'Internship', href: '/en/kurikulum#magang' },
    ...
    },
    {
      label: 'AKADEMIK',
      submenu: [
        { label: 'Kurikulum Program Studi', href: '/kurikulum#kurikulum' },
        { label: 'Prospectus', href: '/kurikulum' },
        { label: 'Profil Lulusan', href: '/kurikulum#profil-lulusan' },
        { label: 'Capaian Pembelajaran Lulusan (CPL)', href: '/kurikulum#cpl' },
        { label: 'Riset & Publikasi', href: '/tulisan-dosen' },
        { label: 'Magang', href: '/kurikulum#magang' },
