    ...
    categories: [
      {
        sections: lang === 'en' ? [
        ...
        ] : [
          {
            ...
            name: 'TENTANG KAMI',
            items: [
              { name: 'Prestasi Program Studi', href: '/#' },
              { name: 'Visi & Misi', href: '/#profil' },
              { name: 'Struktur Organisasi', href: '/#struktur-organisasi' },
              { name: 'Dosen, Laboran dan Karyawan', href: '/#dosen-staff' },
